...
app.post("/ajax/email", function(request, response) {
  // create reusable transporter object using the default SMTP transport
	const transporter = nodemailer.createTransport({
		...
		secure: true,
		auth: {
			user: "vdhakal15@gmail.com", // this should be YOUR GMAIL account
			pass: "Kangana143." // this should be your password
		}
	});
	...
	var mail = {
		from: "vdhakal15@gmail.com", // sender address
		to: "vdhakal15@gmail.com", // list of receivers (THIS COULD BE A DIFFERENT ADDRESS or ADDRESSES SEPARATED BY COMMAS)
